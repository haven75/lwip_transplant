/*
 *
 * FILE : MPC5604E_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains the initialization for MPC5604E derivative.
 *
 *  VERSION: 1.1
 */

#include "MPC5604E.h"   /* platform development header */
#include "MPC5604E_HWInit.h"
