...
set SECTORS_ADD [list 0x0 0x4000 0x8000 0x10000 0x18000 0x1C000 0x20000 0x30000]
...
proc mpc560xx_init {mem_size} {
	...
	if {$r == 0x600000} {
		...
		#catch {reg ${GPR_GROUP}PC = [evaluate __startup]}
...
# initialize MPC560xx ECC SRAM: 96KB
mpc560xx_init 0x18000
